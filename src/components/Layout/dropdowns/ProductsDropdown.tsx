...
import ImmersiveIcon from "../../shared/icons/ImmersiveIcon";
import Link from "next/link";
import ObIcon from "../../shared/icons/ObIcon";
...
export function ProductsDropdown() {
  return (
    <NavigationMenuItem>
      <NavigationMenuTrigger
        showChevron={false}
        className="text-[10px] hover:bg-transparent! focus:bg-transparent! active:bg-transparent! hover:font-extrabold transition-all duration-200 ease-in-out cursor-pointer hover:text-primary bg-transparent"
      >
        What we do
      </NavigationMenuTrigger>
